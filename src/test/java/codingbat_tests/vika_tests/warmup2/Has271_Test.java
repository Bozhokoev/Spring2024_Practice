...
import codingbat.vika.warmup2.Has271;
...
public class Has271_Test {
    ...
    @Test(description = "Verify Has 271 Function", dataProvider = "has_271")
    public void noHas271Test (int nums[], boolean exp) {
        Assert.assertEquals(has271.has271(nums), exp);
    }
}
